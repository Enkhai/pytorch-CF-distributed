...
if __name__ == "__main__":
    ...
    #average model weights for extinct users/items of the training
    #set when compared to the testing set
    untrained_users, untrained_items = test_train_deviation(test_set, train_set)
    calculate_model_untrained_weights(model, untrained_users, untrained_items, 
                                      train_set['userId'].unique(), train_set['movieId'].unique(), cuda=True)
    
    #part 5: testing
    
    test_loss(model, test_set, cuda=True)